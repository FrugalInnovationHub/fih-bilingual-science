  ...
  final List<Map<String, String>> _lessons = [
    {
      ...
      'title_en': 'Teeth',
      'title_es': 'Dientes',
      'function_en': 'Chews and breaks down food into smaller pieces.',
      'function_es':
          'Mastica y descompone los alimentos en trozos más pequeños.',
      'location_en': 'Inside the mouth, attached to the jawbones.',
      'location_es':
          'Dentro de la boca, adheridos a los huesos de la mandíbula.',
      'importance_en': 'Essential for digestion and proper nutrition.',
      'importance_es': 'Esenciales para la digestión y la nutrición adecuada.',
    },
    {
      ...
      'location_en':
          'Inside the mouth, resting on the floor of the oral cavity.',
      'location_es':
          'Dentro de la boca, apoyada en el suelo de la cavidad oral.',
      'importance_en':
    ...
    },
    {
      ...
      'importance_en': 'First step in both digestion and verbal communication.',
      'importance_es': 'Primer paso en la digestión y la comunicación verbal.',
    },
    {
      'image': 'assets/bioappdr/eyes.jpeg',
      'title_en': 'Eyes',
      'title_es': 'Ojos',
      'function_en': 'Detects light and sends visual information to the brain.',
      'function_es': 'Detecta la luz y envía información visual al cerebro.',
      'location_en': 'In the eye sockets (orbits) of the skull.',
      'location_es': 'En las cuencas de los ojos (órbitas) del cráneo.',
      'importance_en': 'Primary organs for vision and spatial awareness.',
      'importance_es':
    ...
    },
    {
      ...
      'title_en': 'Ears',
      'title_es': 'Oídos',
      'function_en': 'Hears sound and helps maintain balance.',
      'function_es': 'Percibe sonidos y ayuda a mantener el equilibrio.',
      'location_en': 'On both sides of the head, just above the jawline.',
      'location_es':
          'A ambos lados de la cabeza, justo encima de la línea de la mandíbula.',
      'importance_en':
  ...
  void _toggleLanguage() {
    setState(() {
      ...
      if (_selectedLesson != null) {
        _speak(
          _isSpanish
              ? _selectedLesson!['title_es']!
              : _selectedLesson!['title_en']!,
        );
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    final title = _selectedLesson != null
        ? (_isSpanish
            ...
            : _selectedLesson!['title_en']!)
        : (_isSpanish
            ? 'Explorador de la Cara 🚀'
            : 'Face Explorer Adventure! 🚀');
    return Scaffold(
