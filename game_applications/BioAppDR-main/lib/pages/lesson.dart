...
class _LessonState extends State<Lesson> {
  ...
  final List<Map<String, String>> lessons = [
    {
      "image": "assets/bioappdr/body.jpg",
      "title_en": "Human Body",
    ...
    {
      "image": "assets/bioappdr/brain.jpg",
      "title_en": "Brain",
      "title_es": "Cerebro",
      "function_en":
    ...
    {
      "image": "assets/bioappdr/stomach.jpeg",
      "title_en": "Stomach",
      "title_es": "Estómago",
      "function_en": "Food storage, mixing, and initial digestion.",
      "function_es": "Almacena, mezcla e inicia la digestión de los alimentos.",
      "location_en":
          "Upper abdomen, between the esophagus and small intestine.",
      "location_es":
          "Abdomen superior, entre el esófago y el intestino delgado.",
      "importance_en": "Breaks down food into a usable form for the body.",
      "importance_es":
    ...
    {
      "image": "assets/bioappdr/kidney.jpeg",
      "title_en": "Kidneys",
      "title_es": "Riñones",
      "function_en":
    ...
    },
    {
      ...
      "title_en": "Bones",
      "title_es": "Huesos",
      "function_en": "Provide structure, support, and protection for the body.",
      "function_es": "Brindan estructura, soporte y protección para el cuerpo.",
