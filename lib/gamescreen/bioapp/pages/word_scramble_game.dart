...
class _WordScrambleGameV2State extends State<WordScrambleGameV2>
  ...
  final List<Map<String, String>> _items = [
    {
      ...
      'img': 'assets/bioappdr/heart.jpeg',
    },
    {
      'en': 'LUNGS',
      'es': 'PULMONES',
      ...
      'img': 'assets/bioappdr/lungs.jpeg',
    },
    {
      'en': 'BRAIN',
      'es': 'CEREBRO',
    ...
    },
    {
      ...
      'img': 'assets/bioappdr/liver.jpeg',
    },
    {
      'en': 'STOMACH',
      'es': 'ESTÓMAGO',
      ...
      'img': 'assets/bioappdr/stomach.jpeg',
    },
  ];
  ...
  void _verify() {
    ...
    if (correct) {
      ...
      _updateProgress(
        _currentWord + 1,
      ); // Update progress for each completed word
  ...
  void _showSnack(bool good, double earned) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          msg +
              (_gameOver ? '' : '  Score: ${_sessionScore.toStringAsFixed(1)}'),
        ),
        backgroundColor:
            good ? theme.colorScheme.secondary : theme.colorScheme.error,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              (_spanish ? 'Puntuación de la sesión: ' : 'Session Score: ') +
                  _sessionScore.toStringAsFixed(1),
            ),
            const SizedBox(height: 8),
            Text(
              (_spanish ? 'Puntuación total: ' : 'Total Score: ') +
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                '${_currentWord + 1}/${_wordOrder.length}',
                ...
                children: List.generate(wordEn.length, (i) {
                  ...
                  return AnimatedBuilder(
                    ...
                    builder: (_, child) => Transform.translate(
                      offset: Offset(
                        math.sin(_shake.value * math.pi * 4) * 6,
                        0,
                      ),
                      child: child,
                    ),
