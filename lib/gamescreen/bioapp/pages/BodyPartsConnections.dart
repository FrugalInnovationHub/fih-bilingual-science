...
import 'package:supersetfirebase/gamescreen/bioapp/pages/Home.dart';
...
class _BodyPartsConnectionsState extends State<BodyPartsConnections>
      ...
      [
        {
          'left_en': 'Eyes',
          'left_es': 'Ojos',
          'right_en': 'Allow vision',
          'right_es': 'Permiten ver',
          'image': 'assets/bioappdr/eyes.jpeg',
        },
        {
          'left_en': 'Ears',
          'left_es': 'Oídos',
          'right_en': 'Enable hearing',
          'right_es': 'Permiten oír',
          'image': 'assets/bioappdr/ears.jpeg',
        },
        {
          'left_en': 'Nose',
          'left_es': 'Nariz',
          'right_en': 'Helps smell',
          'right_es': 'Ayuda a oler',
          'image': 'assets/bioappdr/nose.jpeg',
        },
        {
          'left_en': 'Heart',
          'left_es': 'Corazón',
          'right_en': 'Pumps blood',
          'right_es': 'Bombea sangre',
      ...
      [
        {
          'left_en': 'Brain',
          'left_es': 'Cerebro',
          'right_en': 'Nervous system',
          'right_es': 'Sistema nervioso',
          'image': 'assets/bioappdr/Brain.png',
        },
        {
          'left_en': 'Lungs',
          'left_es': 'Pulmones',
          'right_en': 'Respiratory system',
          'right_es': 'Sistema respiratorio',
          'image': 'assets/bioappdr/Lungs.png',
        },
        {
          'left_en': 'Stomach',
          'left_es': 'Estómago',
          'right_en': 'Digestive system',
          'right_es': 'Sistema digestivo',
          'image': 'assets/bioappdr/Stomach.png',
        },
        {
          'left_en': 'Heart',
          'left_es': 'Corazón',
          'right_en': 'Circulatory system',
          'right_es': 'Sistema circulatorio',
          'image': 'assets/bioappdr/Heart.png',
        },
        {
          'left_en': 'Kidneys',
          'left_es': 'Riñones',
          'right_en': 'Excretory system',
          'right_es': 'Sistema excretor',
      ...
      [
        {
          'left_en': 'Brain',
          'left_es': 'Cerebro',
          'right_en': 'In the skull',
          'right_es': 'En el cráneo',
          'image': 'assets/bioappdr/Brain.png',
        },
        {
          'left_en': 'Liver',
          'left_es': 'Hígado',
          'right_en': 'Upper right abdomen',
          'right_es': 'Abdomen superior derecho',
          'image': 'assets/bioappdr/liver.jpeg',
        },
        {
          'left_en': 'Kidneys',
          'left_es': 'Riñones',
          'right_en': 'Lower back',
          'right_es': 'Espalda baja',
          'image': 'assets/bioappdr/Kidney.png',
        },
        {
          'left_en': 'Lungs',
          'left_es': 'Pulmones',
          'right_en': 'Chest cavity',
          'right_es': 'Cavidad torácica',
          'image': 'assets/bioappdr/Lungs.png',
        },
        {
          'left_en': 'Heart',
          'left_es': 'Corazón',
          'right_en': 'Center of chest',
          'right_es': 'Centro del pecho',
          'image': 'assets/bioappdr/Heart.png',
        },
        {
          'left_en': 'Stomach',
          'left_es': 'Estómago',
          'right_en': 'Upper abdomen',
          'right_es': 'Abdomen superior',
          'image': 'assets/bioappdr/Stomach.png',
        },
      ],
    ]);
      ...
      if (isMatch) {
        ...
        if (_leftCompleted.every((complete) => complete)) {
          ...
          if (_level >= _levels.length) {
            _gameOver = true;
            _feedbackMessage =
                _isSpanish ? '¡Juego completado!' : 'Game completed!';
            // Add score to total
            _addToTotalScore(_score.toDouble());
          } else {
            _feedbackMessage =
                _isSpanish ? '¡Nivel completado!' : 'Level completed!';
  ...
  void _getAiResponse(String userQuery, StateSetter setSheetState) {
    ...
    _gemini.text("$context\n\nThe user asks: $userQuery").then((response) {
      if (mounted) {
        setSheetState(() {
          _aiResponse =
              response?.output ?? "Sorry, I couldn't think of anything.";
          _isLoading = false;
        });
      }
    }).catchError((e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _isSpanish ? 'Conexiones del Cuerpo' : 'Body Parts Connections',
        ),
        actions: [
          IconButton(
          ...
          IconButton(
            ...
            tooltip:
                _isSpanish ? 'Escuchar instrucciones' : 'Hear instructions',
                              ...
                              child: Column(
                                ...
                                children: List.generate(
                                  ...
                                  (index) => _buildCardItem(
                                    ...
                                    isCompleted:
                                        _leftCompleted[_leftOrder[index]],
  ...
  Widget _buildCardItem({
    ...
    final text = _isSpanish
        ? (isLeft ? data['left_es'] : data['right_es'])
        : (isLeft ? data['left_en'] : data['right_en']);
    final imagePath = isLeft ? data['image'] : null;

    final theme = Theme.of(context);
    final Color baseColor =
        isLeft ? theme.colorScheme.primary : theme.colorScheme.secondary;
