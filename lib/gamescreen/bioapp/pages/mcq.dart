...
class _McqState extends State<Mcq> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      "image": "assets/bioappdr/heart.jpeg",
    ...
    {
      "image": "assets/bioappdr/lungs.jpeg",
    ...
    {
      "image": "assets/bioappdr/bone.jpeg",
  ...
  void checkAnswer(String selectedOption) {
    ...
    if (_selectedOption != null && _isCorrect == true)
      return; // Prevent further scoring after correct
        ...
        if (currentIndex < questions.length - 1) {
          ...
          showDialog(
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: Text(
                'You scored $_sessionScore out of ${questions.length} possible!',
              ),
              actions: [
                TextButton(
                  onPressed: () {
      ...
      if (_attempts < 2) {
        ...
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            title: const Text("Incorrect!"),
            content: Text(
              "No points for this question. Try until correct.\nScore: $_sessionScore",
            ),
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(ctx),
  ...
  Future<void> _speakQuestionAndOptions() async {
    ...
    final String questionText =
        _isSpanish ? q["question_es"] : q["question_en"];
    final List<String> opts = List<String>.from(
      _isSpanish ? q["options_es"] : q["options_en"],
    );
  ...
  Widget build(BuildContext context) {
    ...
    final String questionText =
        _isSpanish ? questionData["question_es"] : questionData["question_en"];
    final List<String> displayOptions = List<String>.from(
      _isSpanish ? questionData["options_es"] : questionData["options_en"],
    );
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 0) {
            // Home button: navigate to Bio App home page
            Navigator.pushReplacementNamed(context, '/');
          } else if (index == 1) {
