...
class _BodyPartsButtonGameState extends State<BodyPartsButtonGame>
  ...
  final List<Map<String, dynamic>> _bodyParts = [
    {
      ...
      'description_es':
          'Este órgano bombea sangre a través de tu cuerpo, entregando oxígeno y nutrientes a tus células. ¡Late aproximadamente 100,000 veces al día!',
    ...
    },
    {
      ...
      'description_es':
          'Este órgano controla todas las funciones corporales, pensamientos, emociones y memoria. Es el centro de mando de tu cuerpo.',
      'targetX': 0.5,
      'targetY': 0.12,
      'tolerance': 0.06,
      'sizeFactor': 0.09,
    ...
    },
    {
      ...
      'description_es':
          'Estos órganos te ayudan a respirar tomando oxígeno y liberando dióxido de carbono. Se expanden y contraen mientras respiras.',
    ...
    },
    {
      'name_en': 'Liver',
      'name_es': 'Hígado',
      'imagePath': 'assets/bioappdr/liver.jpeg',
      'description_en':
          'This organ filters blood, detoxifies chemicals, and produces proteins for blood clotting. It also helps with digestion.',
      'description_es':
          'Este órgano filtra la sangre, desintoxica químicos y produce proteínas para la coagulación sanguínea. También ayuda con la digestión.',
      'targetX': 0.58,
      'targetY': 0.46,
      'tolerance': 0.07,
      'sizeFactor': 0.09,
    ...
    },
    {
      ...
      'description_es':
          'Este órgano digiere los alimentos y los mezcla con jugos digestivos. Descompone los alimentos antes de que pasen a los intestinos.',
      'targetX': 0.48,
      'targetY': 0.50,
      'tolerance': 0.07,
      'sizeFactor': 0.09,
    ...
    },
    {
      ...
      'description_es':
          'Estos órganos filtran los desechos de la sangre y producen orina. Ayudan a mantener el equilibrio adecuado de agua y minerales en tu cuerpo.',
      'targetX': 0.5,
      'targetY': 0.58,
      'tolerance': 0.08,
      'sizeFactor': 0.09,
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Error loading $path')));
      }
    }
  }
    ...
    return Positioned(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: (part['color'] as Color).withOpacity(
                0.7,
              ), // More visible shadow
              blurRadius: 8,
              spreadRadius: 2,
                ...
                child: InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: isSelected
                          ? part['color']
                          : (isCurrent ? Colors.white : Colors.orange.shade50),
                      borderRadius: BorderRadius.circular(12), // More rounded
        ...
        return Center(
          child: Transform.scale(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    _isCorrect ? Colors.green.shade400 : Colors.orange.shade300,
                borderRadius: BorderRadius.circular(20),
                boxShadow: [
                  BoxShadow(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          _isSpanish ? 'Juego de Partes del Cuerpo' : 'Body Parts Game',
        ),
          ...
          Positioned(
            ...
            child: Center(
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(30),
                  child: Image.asset(_bodyImagePath, fit: BoxFit.contain),
                ),
              ),
            ),
          ),
