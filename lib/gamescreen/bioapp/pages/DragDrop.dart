...
class _DragDropQuizState extends State<DragDrop> {
  ...
  final List<Map<String, dynamic>> _quizData = [
    {
      ...
      'spanishPrompt':
          'Arrastra la imagen correcta para "El corazón" al objetivo:',
    ...
    },
    {
      ...
      'spanishPrompt':
          'Arrastra la imagen correcta para "La nariz" al objetivo:',
    ...
    },
    {
      ...
      'spanishPrompt':
          'Arrastra la imagen correcta para "El cerebro" al objetivo:',
    ...
    },
    {
      ...
      'spanishPrompt':
          'Arrastra la imagen correcta para "La boca" al objetivo:',
      'spanishWord': 'La boca',
      'englishWord': 'mouth',
      'options': [
        {"data": "El corazón", "image": "assets/bioappdr/heart.jpeg"},
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, String>> options = List<Map<String, String>>.from(
