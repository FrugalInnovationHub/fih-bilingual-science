...
class _FaceLessonState extends State<FaceLesson> {
  ...
  final List<Map<String, String>> faceLessons = [
    {
      // EYES
      "image": "assets/bioappdr/eyes.jpeg",
      "title_en": "Eyes",
      "title_es": "Ojos",
      "function_en":
          "Allow vision, interpret light and color, provide sense of sight.",
      "function_es":
          "Permiten la visión, interpretan la luz y el color, y brindan el sentido de la vista.",
      "location_en": "Front of the face, within the eye sockets.",
      "location_es":
          "Parte frontal de la cara, dentro de las cuencas oculares.",
      "importance_en":
          "Essential for visual perception; many daily tasks rely on sight.",
      "importance_es":
          "Esenciales para la percepción visual; muchas tareas diarias dependen de la vista.",
    },
    {
      // EARS
      "image": "assets/bioappdr/ears.jpeg",
      "title_en": "Ears",
      "title_es": "Oídos",
      "function_en": "Capture sound waves, enabling hearing and balance.",
      "function_es":
          "Captan ondas sonoras, permitiendo la audición y el equilibrio.",
      "location_en": "On either side of the head.",
      "location_es": "A cada lado de la cabeza.",
      "importance_en":
          "Vital for communication and spatial awareness; helps maintain balance.",
      "importance_es":
          "Vitales para la comunicación y la percepción espacial; ayudan a mantener el equilibrio.",
    },
    {
      // NOSE
      "image": "assets/bioappdr/nose.jpeg",
      "title_en": "Nose",
      "title_es": "Nariz",
      "function_en":
          "Filters, warms, and moistens air; provides sense of smell.",
      "function_es":
          "Filtra, calienta y humedece el aire; proporciona el sentido del olfato.",
      ...
      "importance_es":
          "Crucial para la respiración, el olfato y la percepción de sabores.",
    },
    {
      // MOUTH
      ...
      "function_es":
          "Ingiere alimentos, inicia la digestión y permite el habla.",
      ...
      "importance_es":
          "Clave para comer, comunicarse y las expresiones faciales.",
    },
    {
      // TEETH
      "image": "assets/bioappdr/teeth.jpeg",
      "title_en": "Teeth",
      "title_es": "Dientes",
      "function_en": "Chew food into smaller pieces for easier digestion.",
      "function_es":
          "Mastican la comida en trozos más pequeños para facilitar la digestión.",
      "location_en": "Inside the mouth, anchored in the gums.",
      "location_es": "Dentro de la boca, anclados en las encías.",
      "importance_en":
          "Essential for proper nutrition and clear speech; also a key aspect of facial aesthetics.",
      "importance_es":
          "Esenciales para una buena nutrición y una pronunciación clara; también son clave en la estética facial.",
    },
    {
      // TONGUE
      "image": "assets/bioappdr/tongue.jpeg",
      "title_en": "Tongue",
      "title_es": "Lengua",
      "function_en":
          "Facilitates taste, aids in chewing, swallowing, and speech.",
      ...
      "importance_en":
          "Critical for flavor detection, speech articulation, and initiating swallowing.",
      "importance_es":
          "Crítica para la detección de sabores, la articulación del habla y el inicio de la deglución.",
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(
        0xFFFFF3E0,
      ), // This can be themed as well if needed
      appBar: AppBar(
        title: Text(title ?? ""),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            // Image.
            Image.asset(lesson["image"]!, height: 200),
