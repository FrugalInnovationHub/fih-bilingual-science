...
class _FaceQuizGameState extends State<FaceQuizGame>
    ...
    _lessons = [
      {
        ...
        'desc_en': 'Allow vision.',
      },
      {
        'title_en': 'Ears',
        'image': 'assets/bioappdr/ears.jpeg',
        'desc_en': 'Enable hearing.',
      },
      {
        'title_en': 'Nose',
  ...
  void _checkAnswer(String choice) async {
    ...
    setState(() {
      ...
      if (_isCorrect) {
        ...
        _feedbackMessage =
            _attempts == 1 ? 'Try one more time!' : 'Wrong! Try again.';
      }
    });
