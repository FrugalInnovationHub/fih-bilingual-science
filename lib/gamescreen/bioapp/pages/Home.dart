...
import 'package:supersetfirebase/gamescreen/bioapp/components/indexcard.dart';
import 'package:supersetfirebase/gamescreen/bioapp/components/lesson_card.dart';
import 'package:supersetfirebase/gamescreen/bioapp/pages/profile_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: const CircleAvatar(
                      backgroundImage: AssetImage('assets/bioappdr/chunli.jpg'),
                      radius: 40,
                    ),
                  ),
                ],
              ...
              IndexCard(
                ...
                questions: "3",
                progress:
                    "${_calculateProgress(_quizProgress['mcq_progress'] ?? 0, 3)}",
              ...
              IndexCard(
                ...
                progress:
                    "${_calculateProgress(_quizProgress['wordscramble_progress'] ?? 0, 5)}",
              ...
              IndexCard(
                ...
                progress:
                    "${_calculateProgress(_quizProgress['memory_progress'] ?? 0, 4)}",
                onPress: "/memorygame",
              ),
              IndexCard(
                ...
                questions: "4",
                progress:
                    "${_calculateProgress(_quizProgress['dragdrop_progress'] ?? 0, 4)}",
              ...
              IndexCard(
                ...
                questions: "6",
                progress:
                    "${_calculateProgress(_quizProgress['facequiz_progress'] ?? 0, 6)}",
              ...
              IndexCard(
                ...
                questions: "3",
                progress:
                    "${_calculateProgress(_quizProgress['connections_progress'] ?? 0, 3)}",
              ...
              IndexCard(
                ...
                progress:
                    "${_calculateProgress(_quizProgress['assembly_progress'] ?? 0, 6)}",
              ...
              LessonCard(
                ...
                slides: "6",
                onPress:
                    "/facelearningpage", // Named route for Face lesson page
              ),
              const SizedBox(height: 40),
            ],
          ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 0) {
            // Home button: navigate to main app login screen when on Bio App home page
