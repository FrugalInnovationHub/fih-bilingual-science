  ...
  Widget _buildWhatIsLandfillContent() {
    return Stack(
      children: [
        Positioned.fill(
          child: Image.asset(
            'assets/tidytown/images/landfill/whatisl.gif',
            fit: BoxFit.cover,
          ),
        ),
        Positioned(
      ...
      builder: (context, setState) {
        return Stack(
          children: [
            Positioned.fill(
              child: Image.asset(
                'assets/tidytown/images/landfill/whatgoes.webp',
                fit: BoxFit.cover,
              ),
            ),
            Column(
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          SizedBox.expand(
            child: Image.asset(
              'assets/tidytown/images/landfill/learning.webp',
              fit: BoxFit.cover,
            ),
          ),
          SafeArea(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (isCorrect && currentProgress < index + 1) {
                      int totalLandfillItems = landfillItems
